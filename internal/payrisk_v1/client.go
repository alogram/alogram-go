...
// APIClient manages communication with the Alogram PayRisk Engine API v0.2.23
...
type APIClient struct {
	...
	RoadmapPreviewAPI *RoadmapPreviewAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.RoadmapPreviewAPI = (*RoadmapPreviewAPIService)(&c.common)
